...
export function createJokeCardHome(joke) {
  // scard
  const card = document.createElement("section");
  card.setAttribute("class", "question-card__home");
...
export function createJokeCardBookmark(joke) {
  // scard
  const card = document.createElement("section");
  card.setAttribute("class", "question-card__bookmark");
  card.setAttribute("data-js", `question-card-${joke.id}`);
  main.append(card);
